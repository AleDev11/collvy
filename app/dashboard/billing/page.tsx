...
export default async function BillingPage() {
  ...
  const workspaceId = currentMembership.workspace.id

  const [subscription, invoices, memberCount, projectCount] = await Promise.all([
      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col gap-6 p-6 max-w-3xl w-full mx-auto">
          <div>
            ...
            <p className="mt-1 text-muted-foreground">Manage your plan, usage, and invoices</p>
          </div>
